...
function forms(formSelector, modalTimerId) {
	...
	const message = {
		...
		sucsess: 'Спасибо, мы с вами свяжимся',
	...
	function bindPostData(form) {
		form.addEventListener('submit', (event) => {
			...
			//Классический метод перебора из объекта в объект
			// const object = {};
...
function slider({
	...
	let currentSlideNumber = document.querySelector('.offer__slider-counter #current'),
		totalSlideNumber = document.querySelector('.offer__slider-counter #total');
...
/* harmony export */ });
	//Настроивает запрос, фетчит, возвращает промис
